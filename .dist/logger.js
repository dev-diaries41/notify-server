...
exports.notifyLogger = exports.logger = void 0;
...
const notificationTransporter = new winston_1.transports.File({
...
const notifyLogger = (0, winston_1.createLogger)({
    transports: [...commonTransports, notificationTransporter],
});
exports.notifyLogger = notifyLogger;
